...
//	private static final Logger LOG = LoggerFactory.getLogger(GcsRecoverableFsDataOutputStreamTest.class);
//
//	private org.apache.hadoop.fs.FileSystem ghfs;
//
//	@Before
//	public void beforeTest() throws IOException {
//		LOG.debug("Before: Creating GoogleHadoopFileSystem");
...
//		ghfs.initialize(URI.create("gs://dnvriend-test/simple-usage-test.txt"), conf);
//	}
//
//	@Test
//	public void simpleUsageTest() throws IOException {
//		final String bucket = "dnvriend-test";
